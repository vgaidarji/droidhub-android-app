...
data class GitHubRepositoryResponse(
    ...
    @SerialName("subscription_url") val subscriptionsUrl: String?,
    ...
    @SerialName("allow_forking") val isAllowedForking: Boolean?,
    @SerialName("is_template") val isTemplate: Boolean?,
    @SerialName("web_commit_signoff_required") val isWebCommitSignoffRequired: Boolean?,
    ...
    fun toModel() = GitHubRepository(
        ...
        updatedAt = LocalDateTime.from(DateFormatter.gitHubApiResponseDate().parse(updatedAt)),
        stargazersCount = stargazersCount ?: 0,
        watchersCount = watchersCount ?: 0,
        forksCount = forksCount ?: 0,
        topics = topics,
        language = language ?: "",
        license = license?.toModel() ?: License.EMPTY
    )
}
